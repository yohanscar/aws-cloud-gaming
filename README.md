...
| download_graphic_card_driver | Download the Nvidia driver on first boot | `bool` | true |
| install_moonlight | Download and install Moonlight NVIDIA's GameStream Client and GeForce Experience on first boot | `bool` | true |
